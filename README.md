...
## Features
- Auto-detects NFT from tab (OpenSea paths, Etherscan token pages; basic heuristics for others).
...
3. (Optional) In `lib/lit.js`, set `LIT_BUNDLE_URL` if you self-host the Lit bundle.
4. Load unpacked:
